...
void button_init(void) {
    ...
    if (esp_ret != ESP_OK) {
        ...
        vSemaphoreDelete(button_semaphore); // as the initialization of the button failed the semaphore created must be deleted
        button_semaphore = NULL;
    }
    ...
    //4. register the pin isr handler
