...
C_SRCS += \
../app/Oled_Display/oled_display.c 

OBJS += \
./app/Oled_Display/oled_display.o 

C_DEPS += \
./app/Oled_Display/oled_display.d 


# Each subdirectory must supply rules for building sources it contributes
app/Oled_Display/%.o app/Oled_Display/%.su app/Oled_Display/%.cyclo: ../app/Oled_Display/%.c app/Oled_Display/subdir.mk
...
clean: clean-app-2f-Oled_Display

clean-app-2f-Oled_Display:
	-$(RM) ./app/Oled_Display/oled_display.cyclo ./app/Oled_Display/oled_display.d ./app/Oled_Display/oled_display.o ./app/Oled_Display/oled_display.su

.PHONY: clean-app-2f-Oled_Display
